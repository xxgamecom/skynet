...
if mode == "host" then
    ...
    skynet.start(function()
        ...
        local b = obj.b
        skynet.log(string.format("a=%d", obj.a))

        for k,v in ipairs(b) do
            skynet.log(string.format("b[%d]=%s", k,v))
        end
        ...
        for k,v in ipairs(nobj.b) do
            skynet.log(string.format("nobj.b[%d]=%s", k,v))
        end
        ...
        for i = 1, 5 do
            ...
            for k,v in pairs(obj) do
                skynet.log(string.format("%s = %s", k , tostring(v)))
            end
        end
        ...
        for k,v in ipairs(obj.b) do
            skynet.log(string.format("b[%d] = %s", k , tostring(v)))
        end
